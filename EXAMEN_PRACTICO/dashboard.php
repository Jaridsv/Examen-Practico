...
<head>
	...
	<link href="cmce-styles.css" rel="stylesheet">
...
<center>
	...
	<button type="button" class="btn btn-warning" data-bs-toggle="modal1" data-bs-target="#exampleModal1">
  		 Modificar producto
	</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="text" name="nid" class="campo"><br>
		<div id="mensaje1" class="errores">Ingrese dato.</div>
		
		<label>*Producto</label><br>
		<input type="text" name="nProducto" class="campo"><br>
		<div id="mensaje1" class="errores">Ingrese dato.</div>
		
		<label>*Precio</label><br>
		<input type="text" name="Precio" class="campo"><br>
		<div id="mensaje2" class="errores">Ingrese dato.</div>
		
		<label>*Existencia</label><br>
		<input type="text" name="Existencia" class="campo"><br>
		<div id="mensaje3" class="errores">Ingrese dato.</div>
      </div>
