...
<html lang="en">
  <head>
	...
	<div class="container-fluid">
    	<a class="navbar-brand"><b>BIENVENIDO</b> <?php echo $_SESSION['nomusuario']; ?></a> 
  ...
  <br><br>
	...
	<div class="container">
        <p class="m-0 text-center text-white" ><b> Jonathan Martinez de Pinillos Hernandez </b></p>
      </div>
	  <div class="container">
        <p class="m-0 text-center text-white" ><b> Luis Guillermo Hernandez Argueta </b></p>
      </div>
	  <div class="container">
        <p class="m-0 text-center text-white" ><b> Jarid Sanchez Victorio</b></p>
      </div>
      <div class="container">
